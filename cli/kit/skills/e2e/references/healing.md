...
tests, it is the environment and `test` owns it. Three shapes, all seen here:
...
| **A defect** | Everything above is excluded | Hand off to `bugfix`. Do not diagnose it here |
